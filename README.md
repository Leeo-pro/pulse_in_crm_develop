...
2. 開発メンバーに以降のreadmeを参考に環境構築をしてもらう
3. mainブランチから作業ブランチを切ってもらい開発を進める。
...
# rspec(個別実行):例 spec/models/user_spec.rbの17行目
docker-compose run --rm app rspec spec/models/user_spec.rb:17
```
